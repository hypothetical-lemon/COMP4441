...
ggplot(data = df19, aes(x=Var1, y=Freq))+geom_bar(stat = "identity", width = .3)+ggtitle("DEATH COUNT PER MONTH 2019")+scale_x_discrete(limits=month.name)
ggplot(data = df20, aes(x=Var1, y=Freq))+geom_bar(stat = "identity", width =.3)+ggtitle("DEATH COUNT PER MONTH 2020")+scale_x_discrete(limits=month.name)
```
