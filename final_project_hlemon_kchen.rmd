...
n
ggplot(data = dat20, aes(x=MONTHNAME))+geom_bar(width=.7)+ggtitle("DEATH COUNT PER MONTH")
ggplot(data = dat19, aes(x=MONTHNAME))+geom_bar(width=.7)+ggtitle("DEATH COUNT PER MONTH")
```
