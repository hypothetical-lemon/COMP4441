...
ggplot(data = df19, aes(x=df19$Var1, y=df19$Freq))+geom_bar(stat = "identity", width = .3)+ggtitle("DEATH COUNT PER MONTH")+scale_x_discrete(limits=month.name)
ggplot(data = df20, aes(x=df20$Var1, y=df20$Freq))+geom_bar(stat = "identity", width =.3)+ggtitle("DEATH COUNT PER MONTH")+scale_x_discrete(limits=month.name)
```
